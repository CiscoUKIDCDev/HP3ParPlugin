...
public class threeParRESTconstants {
	...
	public static final int WAPI_SSL_TCP_PORT = 8080;
	...
	public static final String GET_SYSTEM_URI = "https://10.51.8.210:8080/api/v1/system";
	public static final String GET_CPG_URI = "https://10.51.8.210:8080/api/v1/cpgs";
